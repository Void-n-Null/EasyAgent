...
def create_agent_template(agent_name=None,
    ...
    with open(path + class_name + ".py", "w") as f:
        f.write(agent_template.format(
            ...
            code_interpreter_import="from easy_agent.tools import CodeInterpreter" if code_interpreter else ""
        ))
...
agent_template = """from easy_agent.agents import Agent
...
example_tool_template = """from easy_agent.tools import BaseTool
